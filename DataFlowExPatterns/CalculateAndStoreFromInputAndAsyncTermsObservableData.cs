...
namespace ATAP.DataFlowExPatterns.CalculateAndStoreFromInputAndAsyncTerms {
    ...
    public abstract class CalculateAndStoreFromInputAndAsyncTermsObservableData<TResults> : IDisposable, ICalculateAndStoreFromInputAndAsyncTermsObservableData<TResults>
    {
        ...
        {
            get => _fetchingIndividualElementsOfTerm1; set => _fetchingIndividualElementsOfTerm1 =
value;
        }

        public NotifyCollectionChangedEventHandler OnFetchingIndividualElementsOfTerm1CollectionChanged
        {
            get => onFetchingIndividualElementsOfTerm1CollectionChanged; set => onFetchingIndividualElementsOfTerm1CollectionChanged =
value;
        }

        public PropertyChangedEventHandler OnFetchingIndividualElementsOfTerm1PropertyChanged
        {
            get => onFetchingIndividualElementsOfTerm1PropertyChanged; set => onFetchingIndividualElementsOfTerm1PropertyChanged =
value;
        }

        public NotifyCollectionChangedEventHandler OnResultsCODCollectionChanged
        {
            get => onResultsCODCollectionChanged; set => onResultsCODCollectionChanged =
value;
        }

        public PropertyChangedEventHandler OnResultsCODPropertyChanged
        {
            get => onResultsCODPropertyChanged; set => onResultsCODPropertyChanged =
value;
        }

        public NotifyCollectionChangedEventHandler OnResultsNestedCODCollectionChanged
        {
            get => onResultsNestedCODCollectionChanged; set => onResultsNestedCODCollectionChanged =
value;
        }

        public PropertyChangedEventHandler OnResultsNestedCODPropertyChanged
        {
            get => onResultsNestedCODPropertyChanged; set => onResultsNestedCODPropertyChanged =
value;
        }

        public NotifyCollectionChangedEventHandler OnSigIsReadyTerm1CollectionChanged
        {
            get => onSigIsReadyTerm1CollectionChanged; set => onSigIsReadyTerm1CollectionChanged =
value;
        }

        public PropertyChangedEventHandler OnSigIsReadyTerm1PropertyChanged
        {
            get => onSigIsReadyTerm1PropertyChanged; set => onSigIsReadyTerm1PropertyChanged =
value;
        }

        public NotifyCollectionChangedEventHandler OnFetchedIndividualElementsOfTerm1CollectionChanged
        {
            get => onFetchedIndividualElementsOfTerm1CollectionChanged; set => onFetchedIndividualElementsOfTerm1CollectionChanged =
value;
        }

        public PropertyChangedEventHandler OnFetchedIndividualElementsOfTerm1PropertyChanged
        {
            get => onFetchedIndividualElementsOfTerm1PropertyChanged; set => onFetchedIndividualElementsOfTerm1PropertyChanged =
value;
        }
...
value;
        ...
        public ConcurrentObservableDictionary<string, byte> ElementSetsOfTerm1Ready
        {
            get => _elementSetsOfTerm1Ready; set => _elementSetsOfTerm1Ready =
value;
        }

        public ConcurrentObservableDictionary<string, double> FetchedIndividualElementsOfTerm1
        {
            get => _fetchedIndividualElementsOfTerm1; set => _fetchedIndividualElementsOfTerm1 =
value;
        }
        ...
        {
            get => _fetchingElementSetsOfTerm1; set => _fetchingElementSetsOfTerm1 =
value;
        }

        public NotifyCollectionChangedEventHandler OnFetchingElementSetsOfTerm1CollectionChanged
        {
            get => onFetchingElementSetsOfTerm1CollectionChanged; set => onFetchingElementSetsOfTerm1CollectionChanged =
value;
        }

        public PropertyChangedEventHandler OnFetchingElementSetsOfTerm1PropertyChanged
        {
            get => onFetchingElementSetsOfTerm1PropertyChanged; set => onFetchingElementSetsOfTerm1PropertyChanged =
value;
        }
        ...
        protected virtual void Dispose(bool iAmBeingCalledFromDisposeAndNotFinalize)
        {
            if (!disposedValue)
            {
                ...
                // if unmanaged (COM) resources are used, then free unmanaged resources (unmanaged objects) and override a finalizer below.
        ...
        public void Dispose()
        {
            // Do not change this code. Put cleanup code in Dispose(bool disposing) above.
            Dispose(true);
            // if unmanaged (COM) resources are used, uncomment the following line if the finalizer is overridden above.
